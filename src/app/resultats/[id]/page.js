    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex justify-center">
        <main className="flex-1 max-w-xl xl:max-w-[960px] w-full px-4 py-4">
            ...
            <div className="bg-navy-card border border-primary/25 rounded-2xl p-5 mb-8 animate-fade-in">
              ...
              {compat !== null ? (
                <>
                  ...
                  {/* barres candidats supprimées — voir spectre politique */}
                </>
              ) : (
                <>
          ...
          {/* ── CTA Partage (visible dès le haut) ── */}
          {isOwnResult && (
            <div className="mb-4 animate-fade-in">
              {!shareSaved && (
                <div className="flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 rounded-xl px-3 py-2 mb-2 text-amber-300 text-[11px]">
                  ...
                  Sauvegarde échouée — le lien ne fonctionnera pas pour tes amis
                </div>
              )}
              <button onClick={copierLien}
          ...
          {/* ── Spectre + Radar (desktop: côte à côte) ── */}
          ...
          {/* ── Désaccords + Pourquoi (desktop: côte à côte) ── */}
          <div className="xl:grid xl:grid-cols-2 xl:gap-4 xl:items-start mb-3">
            {/* Désaccords */}
            {isOwnResult && (() => {
              ...
              return (
                <div className="bg-red-500/[0.06] rounded-xl p-4 border border-red-500/15 mb-5 animate-fade-in" style={{ animationDelay: '0.08s' }}>
            ...
            {/* Pourquoi */}
            <div className="rounded-xl p-4 border mb-5 animate-fade-in" style={{ animationDelay: '0.1s', background: `${premierColor}0a`, borderColor: `${premierColor}25` }}>
